...
当前发布版本：**v1.24.11**。`main` 分支的 GitHub Actions 会自动构建测试并发布 GHCR 镜像；正式版本同时发布 GitHub Release。镜像包位于 [GitHub Container Registry](https://github.com/aafqaq/codex-lb-enhanced/pkgs/container/codex-lb-enhanced)。
